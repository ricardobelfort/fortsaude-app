    ...
    if (typeof status === 'boolean') {
      return status
        ? {
            text: 'Ativo',
            className:
              'inline-flex items-center gap-2 px-2 py-0.5 rounded font-semibold bg-green-100 text-green-700 border border-green-300',
          }
        : {
            text: 'Inativo',
            className:
              'inline-flex items-center gap-2 px-2 py-0.5 rounded font-semibold bg-gray-100 text-gray-700 border border-gray-300',
          };
    }
